...
parser.add_option("-p", "--path", dest="train_path", help="Path to training data.",default="/home/dgxuser138/Team_25_HD/frcnn-from-scratch-with-keras-master/train.txt")
...
parser.add_option("--input_weight_path", dest="input_weight_path", help="Input path for weights. If not specified, will try to load default weights provided by keras.", default="/home/dgxuser138/Team_25_HD/frcnn-from-scratch-with-keras-master/mobilenet_1_0_224_tf.h5")
parser.add_option("--rpn", dest="rpn_weight_path", help="Input path for rpn.", default="/home/dgxuser138/Team_25_HD/frcnn-from-scratch-with-keras-master/models/rpn/rpn.mobilenetv1.weights.48-0.12.hdf5")
parser.add_option("--opt", dest="optimizers", help="set the optimizer to use", default="SGD")
parser.add_option("--elen", dest="epoch_length", help="set the epoch length. def=500", default=50)
parser.add_option("--load", dest="load", help="What model to load", default="/home/dgxuser138/Team_25_HD/frcnn-from-scratch-with-keras-master/mobilenet_1_0_224_tf.h5")
